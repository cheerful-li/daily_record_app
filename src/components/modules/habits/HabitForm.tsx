...
const HabitForm = observer(({ open, onClose, onSubmit, initialData, isEditing = false }: HabitFormProps) => {
      ...
      <DialogContent className="sm:max-w-[500px] p-4 sm:p-6">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-6 py-2 sm:py-4">
            ...
            {/* 描述字段 */}
            <div className="grid grid-cols-1 md:grid-cols-4 items-start md:items-center gap-3 md:gap-4">
              <label htmlFor="description" className="text-sm font-medium md:text-right">
                描述:
              </label>
              <Textarea
                id="description"
            ...
            {/* 频率字段 */}
            <div className="grid grid-cols-1 md:grid-cols-4 items-start md:items-center gap-3 md:gap-4">
              <label htmlFor="frequency" className="text-sm font-medium md:text-right">
                频率:
              </label>
          ...
          <DialogFooter className="grid grid-cols-2 gap-3 sm:grid-cols-none sm:gap-0 mt-4 sm:mt-2">
